...
const page = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-gray-100 to-gray-300 flex items-center justify-center p-3 lg:p-6">
      ...
      <div className="w-full  bg-white/60 backdrop-blur-lg rounded-xl shadow-lg p-2 lg:p-3 space-y-4 border border-white/20">
        <div>
          <button
        ...
        <div className="bg-transparent">
          <div className="space-y-1">
            ...
            <div className="bg-white shadow rounded p-2 md:p-4 lg:p-6">
