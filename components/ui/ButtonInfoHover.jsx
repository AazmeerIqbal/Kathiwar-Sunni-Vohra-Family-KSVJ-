...
export const ButtonInfoHover = ({
  ...
  return (
    <>
      <div className="group relative flex items-center sm:gap-2 md:flex md:flex-row md:gap-2 md:items-center lg:flex lg:flex-row lg:gap-2 lg:items-center">
        <button
