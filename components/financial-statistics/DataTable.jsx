    ...
    <div className="overflow-x-auto">
        ...
        <div className="w-full lg:w-1/2 mb-4 lg:mb-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 text-center">
            ...
            <div className="p-2 sm:p-3 bg-green-200 rounded-md font-semibold">
              Received: <span className="text-green-600">{totalCredit}</span>
            </div>
            <div className="p-2 sm:p-3 bg-blue-200 rounded-md font-semibold">
              Balance: <span className="text-blue-600">{totalBalance}</span>
            </div>
          </div>
      ...
      <AnimatePresence>
        {showDetailedTable && (
          ...
          >
            <DetailedDataTable data={data} loading={loading} />
          </motion.div>
        )}
      </AnimatePresence>
    </div>
